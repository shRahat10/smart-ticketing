...
for (let index = 0; index < seatRowOne.length; index++) {
    seatRowOneButtonsHTML += `<button onclick="seatSelect('${seatRowOne[index]}')" id="${seatRowOne[index]}"class="seat-button w-16 lg:w-20 h-14 bg-[#F7F8F8] rounded-xl flex items-center justify-center">${seatRowOne[index]}</button>`;
}
...
for (let index = 0; index < seatRowTwo.length; index++) {
    seatRowTwoButtonsHTML += `<button onclick="seatSelect('${seatRowTwo[index]}')" id="${seatRowTwo[index]}"class="seat-button w-16 lg:w-20 h-14 bg-[#F7F8F8] rounded-xl flex items-center justify-center">${seatRowTwo[index]}</button>`;
}
